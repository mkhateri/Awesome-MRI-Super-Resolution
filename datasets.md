...
|--------|-------------|----------|----------|
| **fastMRI** | Large-scale dataset for knee and brain MRI | T1, T2, PD, FLAIR | [data](https://fastmri.med.nyu.edu/) |
| **IXI** | Clinical MRI scans from 600 healthy subjects across 3 hospitals | T1, T2, PD, DWI, MRA | [data](https://brain-development.org/ixi-dataset/) |
| **HCP** | High-resolution data from 1,200 adults for connectome mapping | T1, T2, fMRI, DWI | [data](https://www.humanconnectome.org/study/hcp-young-adult/data-releases) |
| **dHCP** | Neonatal MRI for studying early brain development | T1, T2, fMRI | [data](https://www.developingconnectome.org/) |
